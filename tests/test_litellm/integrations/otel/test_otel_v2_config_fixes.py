"""Tests for the follow-up fixes to the V2 OTel instrumentation:
...
from litellm.integrations.otel.baggage import (  # noqa: E402
...
from litellm.integrations.otel.payloads import GuardrailSpanData  # noqa: E402
from litellm.integrations.otel.spans import SpanRole  # noqa: E402

# --------------------------------------------------------------------------- #
#  Problem 1 — baggage allowlists configurable
# --------------------------------------------------------------------------- #
...
def test_baggage_processor_allowlist_uses_config_keys():
    ...
    from litellm.integrations.otel import context as ctx_mod
    from litellm.integrations.otel.emitter import SpanEmitter
    from litellm.integrations.otel.payloads import ServiceSpanData
...
# --------------------------------------------------------------------------- #
#  Problem 4 — typed, provider-agnostic guardrail span data
# --------------------------------------------------------------------------- #
